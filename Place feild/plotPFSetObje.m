...
function plotPFSetObje(filename)
%plotSinglCellPF(filename,TXDTS,spk,G,CellN,xbinNumber,SpeedThreshold)
...
% load('xttsc.mat')
% xttsc=makexttsc2(TXDTS,spk,G,CellN,xbinNumber,SpeedThreshold);
% a=find(G==CellN); 
