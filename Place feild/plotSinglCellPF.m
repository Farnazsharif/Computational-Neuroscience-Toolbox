...
function plotPFSetObj4(filename,TXDTS,spk,CellN,xbinNumber,SpeedThreshold)
%This Function make the place field of any cells using only spikes ndex, so
%to use this program we need to have some spk ndex
...
%load('xttsc.mat')
xttsc=makexttsc2(TXDTS,spk,CellN,xbinNumber,SpeedThreshold);
a=CellN; 
